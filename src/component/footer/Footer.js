...
export const Footer = () => {
    return (
        <footer className='footer-container'>
            ...
            <a href="https://www.linkedin.com/in/rocky-abb69921b/"><i className="fa fa-linkedin"></i></a>
            <a href="https://twitter.com/ImRocky7277" target="_blank"><i className="fa fa-twitter"></i></a> 
            <a href="https://github.com/Rockyraven"><i className="social-icon fa fa-github"> </i></a>
